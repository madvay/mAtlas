    ...
    renderHtml(byId('helpContent'), `
      ...
      <section class="help-card">
        ...
        <div class="help-state-key">
          <div><span class="suppression-sample allowed"><span class="material-symbols-outlined">visibility</span></span><strong>Allowed</strong> — ordinary filtering and prerequisite context.</div>
          <div><span class="suppression-sample excluded"><span class="material-symbols-outlined">visibility_off</span></span><strong>Excluded</strong> — a primary-domain node is not admitted merely as prerequisite context, but an enabled, non-excluded secondary membership may still select it directly.</div>
          <div><span class="suppression-sample prohibited"><span class="material-symbols-outlined">block</span></span><strong>Prohibited</strong> — a node with that primary domain is always hidden, including through secondary memberships and prerequisite closure.</div>
        </div>
