...
function renderFieldOverview(graphData) {
  ...
  return `<section aria-labelledby="fields-heading">
    ...
    <p>The all-in export enables every field and domain. Colors identify each concept’s primary domain; multi-domain concepts have a segmented lower rail.</p>
