...
<head>
  ...
  <style>
    ${staticThemeCss}:root{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:var(--page-bg);line-height:1.5}*{box-sizing:border-box}body{margin:0}a{color:var(--link);text-underline-offset:.16em}a:hover{text-decoration-thickness:2px}.page-header,.semantic-content,.page-footer{max-width:1280px;margin-inline:auto;padding-inline:clamp(1rem,3vw,2.5rem)}.page-header{padding-top:2rem;padding-bottom:1.25rem}.page-header .brand{display:flex;align-items:center;gap:1rem;margin-bottom:1rem;flex-wrap:wrap}.page-header .brand-link{color:inherit;text-decoration:none}.page-header .brand-link:hover,.page-header .brand-link:focus-visible{text-decoration:none}.page-header .brand-logo{width:58px;height:58px;object-fit:contain;flex:0 0 auto}.page-header .brand-copy{min-width:0;display:grid;gap:.4rem}.page-header h1{font-size:clamp(2rem,5vw,4rem);line-height:1.05;margin:.15rem 0 .8rem}.lede{font-size:1.05rem;color:var(--muted)}.resource-nav{display:flex;flex-wrap:wrap;gap:.55rem;margin:1.15rem 0}.resource-nav a{display:inline-flex;align-items:center;border:1px solid var(--line);background:var(--panel);border-radius:999px;padding:.48rem .75rem;text-decoration:none;font-weight:700;font-size:.86rem}.atlas-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:.65rem;margin:1.25rem 0 0}.atlas-stats div{background:var(--panel);border:1px solid var(--line);border-radius:12px;padding:.75rem .9rem}.atlas-stats dt{font-size:1.45rem;font-weight:800}.atlas-stats dd{margin:0;color:var(--muted-2);font-size:.8rem}.semantic-content{padding-bottom:1.5rem}.semantic-content>section,.semantic-directory{display:block;background:var(--panel);border:1px solid var(--line);border-radius:14px;padding:1rem 1.1rem;margin:.85rem 0}.semantic-content h2{margin:.05rem 0 .4rem}.semantic-content p{color:var(--muted)}.field-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:.8rem;margin-top:.9rem}.field-card{border:1px solid var(--line-soft);border-radius:11px;padding:.9rem}.field-card h3{margin:0 0 .35rem}.field-card p{margin:.25rem 0}.domain-chips{display:flex;flex-wrap:wrap;gap:.35rem;list-style:none;padding:0;margin:.75rem 0 0}.domain-chips li{display:inline-flex;font-size:.74rem;border:1px solid var(--line-soft);border-radius:999px}.domain-chips a{display:inline-flex;align-items:center;gap:.32rem;padding:.22rem .45rem;text-decoration:none}.domain-chips a:hover,.domain-chips a:focus-visible{text-decoration:underline}.domain-swatch{display:inline-block;width:.72em;height:.72em;border-radius:50%;background:var(--domain-color);flex:none}.semantic-directory>summary{cursor:pointer;font-size:1rem;font-weight:800}.edge-legend{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:.6rem;margin-top:.9rem}.edge-legend article{border-top:1px solid var(--line-soft);padding:.65rem 0}.edge-legend h3{font-size:.9rem;margin:0 0 .25rem;display:flex;align-items:center;gap:.5rem}.edge-legend p{font-size:.82rem;margin:0}.edge-sample{display:inline-block;width:2.4rem;border-top:3px solid var(--edge-color)}.edge-dashed{border-top-style:dashed}.edge-dotted{border-top-style:dotted}.concept-directory>p{font-size:.86rem}.concept-field{margin:1.1rem 0}.concept-field>h3{border-bottom:2px solid var(--line);padding-bottom:.35rem}.concept-domain{margin:.8rem 0}.concept-domain h4{display:flex;align-items:center;gap:.4rem;margin:.25rem 0}.concept-domain h4 a{display:inline-flex;align-items:center;gap:.4rem}.concept-domain small{color:var(--muted-2);font-weight:600}.concept-domain ul{columns:3;column-gap:1.5rem;margin:.25rem 0;padding-left:1.15rem}.concept-domain li{break-inside:avoid;margin:.13rem 0;font-size:.82rem}.atlas-figure{margin:0;background:var(--figure-bg);border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.atlas-figure-header{max-width:1280px;margin:auto;padding:1.25rem clamp(1rem,3vw,2.5rem) .8rem}.atlas-figure-header h2{margin:0}.atlas-figure-header p{margin:.3rem 0;color:var(--muted)}.atlas-svg-scroll{overflow:auto;padding:0 1rem 1.5rem}.atlas-svg-scroll>svg{display:block;width:max(100%,1400px);height:auto;margin:auto;background:var(--panel-2);box-shadow:var(--shadow)}.atlas-figure figcaption{max-width:1280px;margin:auto;padding:0 clamp(1rem,3vw,2.5rem) 1.25rem;color:var(--muted-2);font-size:.83rem}.page-footer{padding-top:1.3rem;padding-bottom:2.5rem;color:var(--muted-2);font-size:.83rem}.page-footer p{margin:.3rem 0}@media(max-width:900px){.concept-domain ul{columns:2}.atlas-svg-scroll>svg{width:1200px}}@media(max-width:600px){.concept-domain ul{columns:1}.page-header{padding-top:1.25rem}.field-grid,.edge-legend{grid-template-columns:1fr}}@media print{.resource-nav,.semantic-directory{display:none}.atlas-svg-scroll{overflow:visible;padding:0}.atlas-svg-scroll>svg{width:100%;box-shadow:none}.atlas-figure{border:0}}
  </style>
</head>
<body>
